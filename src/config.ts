...
export const siteConfig: SiteConfig = {
	title: "琴酒的博客",
	subtitle: "记录生活，分享技术",
	siteURL: "https://panther9985.github.io/", // 请替换为你的站点URL，以斜杠结尾
	...
	bilibili: {
		vmid: "322993153", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/panther9985",
					external: true,
					icon: "fa7-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/322993153",
					external: true,
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "欢迎来到我的博客！这里记录我的学习与生活", // 公告内容
